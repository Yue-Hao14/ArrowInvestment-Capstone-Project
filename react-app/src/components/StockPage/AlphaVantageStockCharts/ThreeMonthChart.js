...
function ThreeMonthChart({ ticker }) {
  ...
  useEffect(() => {
    async function fetchChartData() {
      ...
      // slice the latest 63 data point (avg 21 trading days per month * 3 months)
      // and reverse them to ascending order
      const slicedDateTimes = dateTimes.slice(0, 63).reverse()
